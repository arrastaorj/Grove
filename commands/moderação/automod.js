    ...
    async execute(interaction) {
        ...
        if (collectors.has(userId)) {
            ...
            return interaction.reply({
                content: `\`-\` <a:alerta:1163274838111162499> Você já iniciou uma solicitação com o sistema de AutoMod. Aguarde ${secondsRemaining} segundos antes de tentar novamente.`,
                ephemeral: true
            })
        }
