    ...
    async execute(interaction) {
        ...
        try {
            ...
            const unmuteEmbed = new EmbedBuilder()
                .setColor("#00ff00")
                .setDescription(
                    `* <:1078434426368839750:1290114335909085257> O usuário **${user.tag}** foi desmutado com sucesso.\n` +
                    `  - O Unmute reabilita a voz de um usuário que foi silenciado, permitindo que ele participe novamente das discussões no servidor de forma construtiva.\n\n` +
                ...
                .setFooter({ text: 'Sistema de desmuta o usuário', iconURL: interaction.member.displayAvatarURL({ dynamic: true }) })
                .setTimestamp();
